...
if (global.ACHIEVEMENT_ENABLED == true)
	option_key[2, i++] = get_text("menu_key_2_" + string(global.hidenotif));
option_key[2, i++] = get_text("menu_key_2_" + string(global.drpenabled));
option_key[2, i++] = get_text("menu_key_2_" + string(global.fastmenu));
option_key[6, 1] = "[F10]";
for (var i = 0; i < 14; i++)
