...
if (con >= 1)
{
	...
	{
		shock_x = bc.x;
		shock_y = (bc.y - (bc.sprite_height / 2));
		shock_ind += 0.25;
		draw_sprite_ext(spr_npc_bc_shock, shock_ind, shock_x, shock_y, bc.image_xscale, bc.image_yscale, bc.image_angle, c_white, bc.image_alpha);	
	}
}
