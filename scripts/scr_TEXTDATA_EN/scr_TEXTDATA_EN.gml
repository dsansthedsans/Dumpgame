function TEXTDATA_EN()
{
	...
	ds_map_add(global.textdata_en, "menu_1_title",	"Choose a File");
	...
	ds_map_add(global.textdata_en, "menu_7_title",		"Enter the name others will see");
	...
	ds_map_add(global.textdata_en, $"menu_name_6",		"Flitcher");
	ds_map_add(global.textdata_en, $"menu_namemsg_6",		"You make me sick.");
	ds_map_add(global.textdata_en, $"menu_name_7",		"Clock");
	ds_map_add(global.textdata_en, $"menu_namemsg_7",		"AND I THOUGHT YOU COULDN'T MAKE IT WORSE.");
	ds_map_add(global.textdata_en, $"menu_name_8",		"Brock");
	ds_map_add(global.textdata_en, $"menu_namemsg_8",		"AND I THOUGHT YOU COULDN'T MAKE IT WORSE.");
	ds_map_add(global.textdata_en, $"menu_name_9",		"BrokenClock");
	ds_map_add(global.textdata_en, $"menu_namemsg_9",		"AND I THOUGHT YOU COULDN'T MAKE IT WORSE.");
	ds_map_add(global.textdata_en, $"menu_name_10",		"BrokenCock");
	ds_map_add(global.textdata_en, $"menu_namemsg_10",		"...WHAT?!?");
	ds_map_add(global.textdata_en, $"menu_name_11",		"CrazyCat");
	ds_map_add(global.textdata_en, $"menu_namemsg_11",		":)");
	ds_map_add(global.textdata_en, $"menu_name_12",		"dsans");
	ds_map_add(global.textdata_en, $"menu_namemsg_12",		"Zero shits given.");
	ds_map_add(global.textdata_en, $"menu_name_13",		"migel");
	...
	// Achievements
	var a = 0;
	ds_map_add(global.textdata_en, $"achievement_name_{a}",		"MINI6");
	ds_map_add(global.textdata_en, $"achievement_desc_{a++}",		"Find the MEE6 toy that's hidden somewhere in the Corridors");
	ds_map_add(global.textdata_en, $"achievement_name_{a}",		"Unbelievable");
	ds_map_add(global.textdata_en, $"achievement_desc_{a++}",		"Draw a smiley face.");
	ds_map_add(global.textdata_en, $"achievement_name_{a}",		"Fashion Statement");
	ds_map_add(global.textdata_en, $"achievement_desc_{a++}",		"Get the armor that smells like strawberry");
	ds_map_add(global.textdata_en, $"achievement_name_{a}",		"");
	ds_map_add(global.textdata_en, $"achievement_desc_{a++}",		"Get a weapon by completing a monster's request");
	...
	ds_map_add(global.textdata_en, $"achievement_name_{a}",		"");
	ds_map_add(global.textdata_en, $"achievement_desc_{a++}",		"Complete reCAPTCHA's third stage in under 30 seconds");
	ds_map_add(global.textdata_en, $"achievement_name_{a}",		"Not The Real One");
	ds_map_add(global.textdata_en, $"achievement_desc_{a++}",		"Battle a monster sent by a greater force");
	ds_map_add(global.textdata_en, $"achievement_name_{a}",		"The Real One");
	ds_map_add(global.textdata_en, $"achievement_desc_{a++}",		"Find and defeat the forgotten creature\nof this world");
	...
	*/
	...
	ds_map_add(global.textdata_en, "item_name_stick_serious",		"Broom");
	...
	ds_map_add(global.textdata_en, "item_desc_stick",		"* Broomstick - [0 ATK]^1&* It's about to break.");
	...
	ds_map_add(global.textdata_en, "item_desc_bowl",		"* Candy Bowl - [3 DEF]^1&* Smells like strawberry.");
	...
	ds_map_add(global.textdata_en, "item_equip", "* (You equipped ");
	ds_map_add(global.textdata_en, "item_use_0", "* (You used ");
	ds_map_add(global.textdata_en, "item_use_1", "&* (You restored ");
	ds_map_add(global.textdata_en, "item_use_2", "&* (Your HP was maxed out.)");
	ds_map_add(global.textdata_en, "item_drop_0.0", "* (");
	ds_map_add(global.textdata_en, "item_drop_0.1_0", " was dumped.)");
	ds_map_add(global.textdata_en, "item_drop_0.1_1", " was put away.)");
	ds_map_add(global.textdata_en, "item_drop_0.1_2", " was thrown away.)");
	ds_map_add(global.textdata_en, "item_drop_0.1_3", " was tossed away.)");
	ds_map_add(global.textdata_en, "item_drop_0.1_4", " was kicked out.)");
	ds_map_add(global.textdata_en, "item_drop_0.1_5", " was banned.)");
	ds_map_add(global.textdata_en, "item_drop_0.1_6", " was discarded.)");
	ds_map_add(global.textdata_en, "item_drop_0.1_7", " was evicted.)");
	ds_map_add(global.textdata_en, "item_drop_0.1_8", " was abandoned.)");
	ds_map_add(global.textdata_en, "item_drop_0.1_9", " was forgotten.)");
	ds_map_add(global.textdata_en, "item_pickup", "* (You got :Y");
	ds_map_add(global.textdata_en, "item_cantpickup", "* (You have too many items.)");
	// Worlds
	...
	ds_map_add(global.textdata_en, "chapter_number_0", "I");
	ds_map_add(global.textdata_en, "chapter_number_1", "II");
	ds_map_add(global.textdata_en, "chapter_number_2", "III");
	ds_map_add(global.textdata_en, "chapter_name_0", "FALLEN ANGEL");
	ds_map_add(global.textdata_en, "chapter_name_1", "ROCK BOTTOM");
	ds_map_add(global.textdata_en, "chapter_name_2", "CIVILIZED CHAOS");
	// Inventory & Pause Menus
	ds_map_add(global.textdata_en, "charamenu_main_info_3", "$");
	ds_map_add(global.textdata_en, "charamenu_item_title_0", "YOUR ITEMS");
	...
	ds_map_add(global.textdata_en, "charapause_warning_title", "Are you sure?\nUnsaved progress\nwill be ERASED.");
	...
	// Genocide narrator (UNUSED)
	ds_map_add(global.textdata_en, "unused_genofeeling", ";R* (Something tells you that you shouldn't continue yet.)");
	ds_map_add(global.textdata_en, "unused_genodialog_0_0", "* (You feel the power in your hands...)");
	ds_map_add(global.textdata_en, "unused_genodialog_0_1", "* (... and the strength crossing through your veins.)");
	ds_map_add(global.textdata_en, "unused_genodialog_0_2", "* (Your desire to )");
	ds_map_add(global.textdata_en, "unused_genodialog_0_3", "* (But nobody came.)");
	ds_map_add(global.textdata_en, "unused_genodialog_1_0", "* (Just as before,^1 the sound of emptiness arrives yet again.)");
	ds_map_add(global.textdata_en, "unused_genodialog_1_1", "* (Your strength and patience only rises )");
	ds_map_add(global.textdata_en, "unused_genodialog_1_1", "* (However,^1 your urge is far to being fulfilled.)");
	...
	// begone
	ds_map_add(global.textdata_en, "event_rhonhey_battle_0_0", "* I apologize for not interrupting earlier.");
	ds_map_add(global.textdata_en, "event_rhonhey_battle_0_0", "* I was not aware that ");
	...
	*/
	...
	// room_corridors_1_5
	ds_map_add(global.textdata_en, "room_rockpile_0_0", "* (It's a pile of rocks.)");
	ds_map_add(global.textdata_en, "room_rockpile_1_0", "* (Oh,^3 my God!^1 It can't be!)^2&* (It's a pile of rocks.)");
	// room_corridors_2
	...
	ds_map_add(global.textdata_en, "room_m6_brokenwall_0", "* (There's an ant-sized toy&of MEE6 inside the crack&of this wall.)"); // references a bug where a tiny MEE6 appeared next to the actual MEE6
	ds_map_add(global.textdata_en, "room_m6_brokenwall_1", "* (Strangely,^1 the toy is depicting MEE6 as a&tall robot.)"); // references MEE6's old design
	// room_corridors_3
	ds_map_add(global.textdata_en, "unused_room_stairssign_0", "* \"Hey!\"^1&* \"It's great that you're here!\"");
	ds_map_add(global.textdata_en, "unused_room_stairssign_1", "* \"Pretty soon you'll be at the city,^3 don't worry.\"^1&* \"This shouldn't take long.\"");
	ds_map_add(global.textdata_en, "unused_room_stairssign_2", "* \"It's kind of a legal thing,^3 you know?\"");
	ds_map_add(global.textdata_en, "unused_room_stairssign_3", "* \"Signed,^1 your local&Dumpster Friend\"");
	...
	ds_map_add(global.textdata_en, $"room_rulesbook_5-{i++}", "* (You have become the fastest drawer in the world.)"); // from https://www.youtube.com/watch?v=IqzMUn90tMg
	...
	ds_map_add(global.textdata_en, $"room_rulesbook_5-{i++}", "* (It might be a tumor.)"); // from https://www.youtube.com/watch?v=t_FRWUPcR7Y&t=38s
	...
	ds_map_add(global.textdata_en, $"room_rulesbook_5-{i++}", "* (Or is it because you want to see far dialogue goes...?)");
	ds_map_add(global.textdata_en, $"unused_room_rulesbook_5-{i++}", "* (You don't know what you're getting into.)");
	ds_map_add(global.textdata_en, $"unused_room_rulesbook_5-{i++}", "* (It's not worth it,^1 you know.)^1&* (No one will be impressed.)^1&* (Nothing will come from this.)");
	ds_map_add(global.textdata_en, $"unused_room_rulesbook_5-{i++}", "* (No one will congratulate you or be proud of you.)^1&* (No one will care.)");
	ds_map_add(global.textdata_en, $"unused_room_rulesbook_5-{i++}", "* (Of all things you could be doing,^3 why would you pick this?)");
	ds_map_add(global.textdata_en, $"unused_room_rulesbook_5-{i++}", "* (Don't you realize you're wasting your own time?)");
	...
	*/
	...
	// room_corridors_3_5
	ds_map_add(global.textdata_en, "npc_dummy_0", "* (It's a training dummy.)");
	...
	ds_map_add(global.textdata_en, "event_m6_captcha1_0_0", "* This is the door that has trapped me here for all of this time.");
	ds_map_add(global.textdata_en, "event_m6_captcha1_0_1", "* I have never understood the reason behind the puzzles' difficulty.");
	ds_map_add(global.textdata_en, "event_m6_captcha1_0_2", "* In any way,^1 I believe you should read the sign next to the door.");
	ds_map_add(global.textdata_en, "event_m6_captcha1_0_3", "* It may help you find the answer to the puzzles!");
	// room_corridors_5
	...
	ds_map_add(global.textdata_en, "room_captcha_guidesign_1_0", "* \"Step on the buttons to enter what is shown above.\"");
	ds_map_add(global.textdata_en, "room_captcha_guidesign_1_1", "* \"Restart the puzzle by stepping on the 'X' button.\"");
	...
	ds_map_add(global.textdata_en, "npc_armsguy1_0_1", "* Cool.^1&* Me An Armsguy.^1&* Call Me Armsguy.");
	ds_map_add(global.textdata_en, "npc_armsguy1_0_2", "* Why Me Not Fight You?^2&* Easy.^1 No Why.");
	ds_map_add(global.textdata_en, "npc_armsguy1_0_3", "* You A Kid.^1 You Weak.^1&* Me Stronger Than You.");
	ds_map_add(global.textdata_en, "unused_npc_armsguy1_0_4", "* But If You Kill.^1 Me Run!!");
	ds_map_add(global.textdata_en, "npc_armsguy1_1_0", "* Try Be Cool With Monsters.");
	ds_map_add(global.textdata_en, "npc_armsguy1_1_1", "* They Hurt You Because&They Scared.");
	ds_map_add(global.textdata_en, "npc_armsguy1_1_2", "* If You Don Hurt Them,^1 You Cool.");
	// obj_event_m6_captcha1_1
	ds_map_add(global.textdata_en, "event_m6_captcha1_1_0", "* You opened the door?!");
	ds_map_add(global.textdata_en, "event_m6_captcha1_1_1", "* I knew you would!");
	ds_map_add(global.textdata_en, "event_m6_captcha1_1_2", "* Thank you,^1 new member.");
	ds_map_add(global.textdata_en, "event_m6_captcha1_1_3", "* Unfortunately,^1 this is not the only door you will have to open.");
	ds_map_add(global.textdata_en, "event_m6_captcha1_1_4", "* But,^1 let us keep going!");
	// room_corridors_6
	...
	ds_map_add(global.textdata_en, "room_candybowl_0_2", "* (You took a candy.)^3&* (You got :YCheap Candy;D.)");
	...
	ds_map_add(global.textdata_en, "room_candybowl_1_4", "* (You took the bowl.)^3&* (You got :YCandy Bowl;D.)");
	...
	ds_map_add(global.textdata_en, "room_bench_geno_0", "* (It's a bench.)");
	ds_map_add(global.textdata_en, "npc_trashguy_0", "* (It's a normal trash can.)");
	ds_map_add(global.textdata_en, "npc_trashguy_1", "* (Actually,^3 it's a gruesome hungry creature pretending to be a normal trash can.)");
	ds_map_add(global.textdata_en, "npc_trashguy_2", "* (Life really takes some wild turns sometimes...!)");
	ds_map_add(global.textdata_en, "room_benchlamp_0", "* (Even a broken lamp needs to take a break sometime.)");
	ds_map_add(global.textdata_en, "room_benchlamp_0_geno", "* (It's a lamp.)");
	// room_corridors_8
	...
	ds_map_add(global.textdata_en, "npc_armsguy_lost_0_0_2", "* Me Give You Gift For It.^3&* Very Good Gift.");
	ds_map_add(global.textdata_en, "npc_armsguy_lost_0_0_3", "* (Do you want to help Armsguy?)");
	ds_map_add(global.textdata_en, "npc_armsguy_lost_0_0_3_1", "Yes");
	ds_map_add(global.textdata_en, "npc_armsguy_lost_0_0_3_2", "No");
	ds_map_add(global.textdata_en, "npc_armsguy_lost_0_1_0", "* Cool.^3&* Me Wait Here.");
	ds_map_add(global.textdata_en, "npc_armsguy_lost_0_2_0", "* Didn Even Need It Anyways.");
	...
	ds_map_add(global.textdata_en, "npc_armsguy_lost_1_1_0", "* Good Job Human.");
	ds_map_add(global.textdata_en, "npc_armsguy_lost_1_1_1", "* As Me Said,^3 Me Give You Gift.");
	ds_map_add(global.textdata_en, "npc_armsguy_lost_1_1_0__", "* Hey Human.");
	ds_map_add(global.textdata_en, "npc_armsguy_lost_1_1_1__", "* You Helped Me Dumbass Buddy.^1&* Me Give You Gift.");
	ds_map_add(global.textdata_en, "npc_armsguy_lost_1_1_2", "* Me Don Know What Is,^1 But Me Found It Around Here.");
	...
	ds_map_add(global.textdata_en, "npc_armsguy_lost_1_1_5_0", "* (You got :YKunai;D.)");
	ds_map_add(global.textdata_en, "npc_armsguy_lost_1_1_4_1", "* You Have No Space?");
	ds_map_add(global.textdata_en, "npc_armsguy_lost_1_1_5_1", "* Dump Something And Me Give You Gift.");
	ds_map_add(global.textdata_en, "npc_armsguy_lost_1_2_0", "* What?^3 Didn Like It?^2&* Deal With It");
	ds_map_add(global.textdata_en, "npc_trashguy_lost2", "* ...thanks...");
	// obj_event_m6_captcha2
	ds_map_add(global.textdata_en, "event_m6_captcha2_0", "* Here comes more extremely difficult puzzles for you.");
	ds_map_add(global.textdata_en, "event_m6_captcha2_1", "* The faster we go,^3&the sooner we leave&this place.");
	// room_corridors_9
	...
	ds_map_add(global.textdata_en, "room_captcha_guidesign_1_2", "* \"Restart the puzzle by pressing the 'X' button.\"");
	...
	ds_map_add(global.textdata_en, "event_m6_postcaptcha2_0", "* How do you solve them so easily?!");
	...
	ds_map_add(global.textdata_en, "room_chocosign", "* \"          for completing&           f reCAPTCHA's&           n.\"");
	ds_map_add(global.textdata_en, "room_chocosign_geno", "* (The left half of this sign is missing.)");
	// room_corridors_11
	ds_map_add(global.textdata_en, "room_preclocksign_0", "* \"Hey!\"^1&* \"Don't worry,^3 you're almost there.^3 Just a few rooms away!\"");
	ds_map_add(global.textdata_en, "room_preclocksign_1", "* \"Why not speed up a bit and finish early?\"^1&* \"Think of it like this\\:\\\"");
	ds_map_add(global.textdata_en, "room_preclocksign_2", "* \"Brick by brick,^3 you make a bridge.^1 In the blink of an eye,^3 you'll save time!\"");
	ds_map_add(global.textdata_en, "room_preclocksign_3", "* \"Does that make sense?\"^1&* \"Signed,^1 your local&Dumpster Friend\""); // from Sans's "You gained LOVE" dialog in UNDERTALE
	// obj_event_brock
	ds_map_add(global.textdata_en, "event_brock_battle_0_0", "+S1* DID YOU REALLY THINK I WOULDN'T SEE YOU?!?");
	ds_map_add(global.textdata_en, "event_brock_battle_0_1", "+S1* EVEN AFTER EVERYTH()");
	ds_map_add(global.textdata_en, "event_brock_battle_0_2", "* You are breaking the server's rules,^3 wild clock creature!");
	ds_map_add(global.textdata_en, "event_brock_battle_0_3", "* You cannot trap us he()");
	ds_map_add(global.textdata_en, "event_brock_battle_1_0", "+S1* SHUT UP!!!!!!!!!!");
	ds_map_add(global.textdata_en, "event_brock_battle_2_0", "+S1* AS I WAS SAYING...");
	ds_map_add(global.textdata_en, "event_brock_battle_2_1", "+S1* DO YOU THINK YOU CAN JUST WALK PAST ME AND IGNORE MY EXISTENCE?!?");
	ds_map_add(global.textdata_en, "event_brock_battle_2_2", "+S1* ABSOLUTELY NO WAY,^1 BUDDY.^3&* NOT AFTER EVERYTHING YOU HUMANS DID TO ME.");
	ds_map_add(global.textdata_en, "event_brock_battle_2_3", "+S1* I'VE BEEN COUNTING DOWN THE SECONDS UNTIL THIS DAY,^1 RIGHT HERE,^3 FOR MONTHS!!!!");
	ds_map_add(global.textdata_en, "event_brock_battle_2_4", "+S1* SO LET'S MAKE THE WAIT WORTH IT...!");
	//ds_map_add(global.textdata_en, "event_brock_battle_2_3", "+S1* THERE'S NO TURNING BACK THE HANDS OF TIME.");
	//ds_map_add(global.textdata_en, "event_brock_battle_2_3", "+S1* YOU WOULDN'T WANNA RUIN THIS MOMENT FOR ME,^1 WOULD YOU?!");
	//ds_map_add(global.textdata_en, "event_brock_battle_2_", "+S1* AND NOW'S THE TIME TO SAY GOODBYE...!");
	//ds_map_add(global.textdata_en, "event_brock_battle_2_", "+S1* AND NOW'S THE TIME TO MAKE IT HAPPEN...!");
	/*
	ds_map_add(global.textdata_en, "event_brock_battle_2_3", "+S1* I'VE BEEN WAITING RIGHT HERE FOR MONTHS,^3 COUNTING DOWN THE SECONDS UNTIL THIS DAY...");
	ds_map_add(global.textdata_en, "event_brock_battle_2_4", "+S1* THE DAY I'D FINALLY GET MY REVENGE...!");
	ds_map_add(global.textdata_en, "event_brock_battle_2_5", "+S1* AND HERE.^2 YOU.^2 ARE!!!!^1&* YOU HAVE NO IDEA OF HOW HAPPY I AM TO SEE YOU!!!!!"
	*/
	/*
	ds_map_add(global.textdata_en, "event_brock_prebattle_1_4", "* NOW,^1 IN CASE YOU'RE WONDERING WHAT I'M GONNA DO TO YOU EXACTLY...");
	ds_map_add(global.textdata_en, "event_brock_prebattle_1_5", "* WELL...^1&* FOR THE SAKE OF ARGUMENT...^1&* LET'S SAY THAT...");
	ds_map_add(global.textdata_en, "event_brock_prebattle_1_6", "* YOU'LL FIND OUT VERY SOON...!");
	*/
	var i = 0;
	ds_map_add(global.textdata_en, $"event_brock_battle_3_{i++}", "+S1* YOU...^2 SPARED ME?^2&* EVEN AFTER I TRIED&TO KILL YOU?!");
	ds_map_add(global.textdata_en, $"event_brock_battle_3_{i++}", "+S1* WHY WOULD YOU TRUST ME?^1&* WHY WOULD YOU RISK YOUR OWN LIFE JUST FOR ME?");
	ds_map_add(global.textdata_en, $"event_brock_battle_3_{i++}", "+S1* WHY ARE YOU SO...^4 KIND...?");
	ds_map_add(global.textdata_en, $"event_brock_battle_3_{i++}", "+S1* LOOK,^1 YOU SHOULDN'T SAY SORRY.^1&* YOU DIDN'T DO ANYTHING WRONG.");
	ds_map_add(global.textdata_en, $"event_brock_battle_3_{i++}", "+S1* I DID.^1 NOT YOU,^1 ME.");
	ds_map_add(global.textdata_en, $"event_brock_battle_3_{i++}", "+S1* AND I'M SORRY.^1 I REALLY AM!^1&* I'M REALLY,^1 REALLY SORRY...!");
	ds_map_add(global.textdata_en, $"event_brock_battle_3_{i++}", "+S1* I'VE WASTED ENOUGH OF YOUR TIME ALREADY.");
	/*
	until next time!!!!!!!
	*/
	/*
	ds_map_add(global.textdata_en, "event_brock_postbattle_0_4", "* AFTER THEY INVADED THE CORRIDORS,^1 THE LEADERS&CREATED A NEW RULE.");
	ds_map_add(global.textdata_en, "event_brock_postbattle_0_6", "* IT SAYS THAT EVERY UNINVITED NEW MEMBER SHOULD BE KILLED BEFORE LEAVING THE CORRIDORS.");
	ds_map_add(global.textdata_en, "event_brock_postbattle_0_8", "* I'LL TRY TO TALK TO GABEE ABOUT LETTING YOU GO.^1&* NO PROMISES,^3 THOUGH.");
	ds_map_add(global.textdata_en, "event_brock_postbattle_0_9", "* ... GABEE?^1&* HE'S THE GUARDIAN OF THE CORRIDORS.");
	ds_map_add(global.textdata_en, "event_brock_postbattle_0_10", "* HE'S THE ONE KEEPING THE RULE IN CHECK.");
	
	ds_map_add(global.textdata_en, "event_brock_postbattle_1_0", "* Where is it?");
	ds_map_add(global.textdata_en, "event_brock_postbattle_1_1", "* Where did that clock go?");
	
	ds_map_add(global.textdata_en, "event_brock_postbattle_1_2_0", "* ... What?^1&* You let it go?");
	ds_map_add(global.textdata_en, "event_brock_postbattle_1_3_0", "* That was not very smart of you.");
	ds_map_add(global.textdata_en, "event_brock_postbattle_1_4_0", "* It could come back to kill both of us.");
	
	ds_map_add(global.textdata_en, "event_brock_postbattle_1_2_1", "* ... What?^1&* You killed it?");
	ds_map_add(global.textdata_en, "event_brock_postbattle_1_3_1", "* That is a surprise.");
	ds_map_add(global.textdata_en, "event_brock_postbattle_1_4_1", "* However,^1 it is an welcome one,^1 for sure.");
	
	ds_map_add(global.textdata_en, "event_brock_postbattle_2_0_0", "* Let us just keep going.");
	ds_map_add(global.textdata_en, "event_brock_postbattle_2_0_1", "* Well,^1 let us keep going!");
	*/

	// room_corridors_13
	ds_map_add(global.textdata_en, "npc_armsguy_postbrock_0_0", "* You Da New Member Da Guys Talk About.");
	ds_map_add(global.textdata_en, "npc_armsguy_postbrock_0_1", "* Me Watch You Fight Brock.^1&* Very Epic!");
	ds_map_add(global.textdata_en, "npc_armsguy_postbrock_0_2", "* Me Laugh When Brock&Scare Meeseeks.^3&* Total Clanker.");
	ds_map_add(global.textdata_en, "npc_armsguy_postbrock_1_0", "* Brock Is Very Chill.^1&* He A Cool Guy!");
	ds_map_add(global.textdata_en, "npc_armsguy_postbrock_1_1", "* He Got Angry After Invasion,^1 But He Not Always Angry.");
	ds_map_add(global.textdata_en, "npc_armsguy_postbrock_1_2", "* Why He Angry At You?");
	ds_map_add(global.textdata_en, "unused_npc_flitcher_postbrock_0", "It stares into the abyss, thinking.");
	ds_map_add(global.textdata_en, "unused_npc_flitcher_postbrock_1", "That is, if it thinks.");
	ds_map_add(global.textdata_en, "unused_npc_flitcher_postbrock_2", "Perhaps it's waiting for an answer.");
	ds_map_add(global.textdata_en, "unused_npc_flitcher_postbrock_3", "Or, perhaps,");
	// room_corridors_14
	ds_map_add(global.textdata_en, "room_captcha_mainsign_3_0", "* \"reCAPTCHA\\:  Stage 3/3\"");
	ds_map_add(global.textdata_en, "room_captcha_mainsign_3_1", "* \"Please solve three puzzles to confirm you are a human.\"");
	ds_map_add(global.textdata_en, "room_captcha_mainsign_3_2", "* \"You have :Rone minute;D to solve the puzzles.\"");
	ds_map_add(global.textdata_en, "room_captcha_mainsign_3_3", "* \"Pull both levers next to the door to begin.\"");
	ds_map_add(global.textdata_en, "room_captcha_guidesign_3_3_0", "* \"Activate all plates.\"&* \"Stepping on a plate activates nearby plates.\"");
	ds_map_add(global.textdata_en, "room_captcha_guidesign_3_3_1", "* \"Restart the puzzle by stepping on the 'X' button.\"");
	...
	ds_map_add(global.textdata_en, "npc_armsguy_exit_1_1", "* Da Raid Was Nuts!^3&* Da Corridor There&Broken Totally.");
	ds_map_add(global.textdata_en, "npc_armsguy_exit_1_2", "* Da Humans Killed My Grandma!^1&* But Me Cool Now."); // from Trolls. Not sure why I added this
	...
	ds_map_add(global.textdata_en, "npc_armsguy_exit_fishing_0_0", "* What Up.^1&* Me Just Waiting This Smartass Here Get Thing Back.");
	ds_map_add(global.textdata_en, "npc_armsguy_exit_fishing_0_1", "* Big Waste Of Time!^3&* How That Fall There Anyway!?");
	ds_map_add(global.textdata_en, "npc_armsguy_exit_fishing_0_2", "* ...i already told you&i don't know...");
	ds_map_add(global.textdata_en, "npc_armsguy_exit_fishing_1_0", "* This Intolerable!"); // from Indiana Jones and the Last Crusade
	ds_map_add(global.textdata_en, "npc_armsguy_exit_lifting_0_0", "* Me Don Talk Now.^3&* I Gyming.");
	...
	ds_map_add(global.textdata_en, "npc_armsguy_exit_lifting_3_0", "* I Kill You!!!!!!!!!!!!");
	ds_map_add(global.textdata_en, "npc_armsguy_exit_lifting_4_0", "* Ahhhhhh!!!!!!!!!!!!!!!!!!");
	...
	ds_map_add(global.textdata_en, "npc_flitcher_exit_1_0", "* Please,^2 help me.");
	...
	ds_map_add(global.textdata_en, $"unused_event_gabee_chase.3.0", "* (You hear a distant voice.)");
	var i = 0;
	ds_map_add(global.textdata_en, $"event_gabee_chase.3.{i++}", "* ele ta ali^1&* ta vendo?");
	ds_map_add(global.textdata_en, $"event_gabee_chase.3.{i++}", "* tu acha q ele morreu?");
	ds_map_add(global.textdata_en, $"event_gabee_chase.3.{i++}", "* ...");
	ds_map_add(global.textdata_en, $"event_gabee_chase.3.{i++}", "* ");
	// room_cave_2
	var i = 0;
	ds_map_add(global.textdata_en, $"cellphone_developer_{i++}", "* (Ring,^1 ring...)");
	ds_map_add(global.textdata_en, $"cellphone_developer_{i++}", "* (It's a voice you have never heard before.)"); // from UNDERTALE
	ds_map_add(global.textdata_en, $"cellphone_developer_{i++}", "* Hey.");
	ds_map_add(global.textdata_en, $"cellphone_developer_{i++}", "* It must be obvious by now that I like UNDERTALE.");
	ds_map_add(global.textdata_en, $"cellphone_developer_{i++}", "* But it's more than&that,^1 really.^1&* Way more than that.");
	ds_map_add(global.textdata_en, $"cellphone_developer_{i++}", "* I met all my friends literally just because of UNDERTALE.");
	ds_map_add(global.textdata_en, $"cellphone_developer_{i++}", "* I might've never gotten better at drawing without UNDERTALE.");
	ds_map_add(global.textdata_en, $"cellphone_developer_{i++}", "* I probably would've never gotten into programming without UNDERTALE.");
	ds_map_add(global.textdata_en, $"cellphone_developer_{i++}", "* I definitely would've never even thought of making music without UNDERTALE.");
	ds_map_add(global.textdata_en, $"cellphone_developer_{i++}", "* Basically,^1 I'd have a completely different life and personality without UNDERTALE.");
	ds_map_add(global.textdata_en, $"cellphone_developer_{i++}", "* ...");
	ds_map_add(global.textdata_en, $"cellphone_developer_{i++}", "* It's weird,^1 isn't it?");
	ds_map_add(global.textdata_en, $"cellphone_developer_{i++}", "* Knowing someone you've never met,^1 and most certainly never will,^1 has changed you forever.");
	ds_map_add(global.textdata_en, $"cellphone_developer_{i++}", "* In a good way!");
	ds_map_add(global.textdata_en, $"cellphone_developer_{i++}", "* Well,^2 I just wanted to say...");
	ds_map_add(global.textdata_en, $"cellphone_developer_{i++}", "* You made a snowman&really happy...!"); // from UNDERTALE
	ds_map_add(global.textdata_en, $"cellphone_developer_{i++}", "* (Click...)");
	// room_cave_3
	ds_map_add(global.textdata_en, "room_cave_3_npc_armsguy.0.0", "* Ahh!^3 You Here Too!");
	ds_map_add(global.textdata_en, "room_cave_3_npc_armsguy.0.1", "* Look Like Me Not Da Only That Try To Jump!^3&* Mweheheh!!");
	ds_map_add(global.textdata_en, "room_cave_3_npc_armsguy.1.0", "* If Me Was Little Closer To Hole,^1 Me Jump To Other Side.");
	ds_map_add(global.textdata_en, "room_cave_3_npc_armsguy.1.1", "* But You??^3&* You A Human Yes?^1&* You Very Weak!");
	...
	var i = 0;
	ds_map_add(global.textdata_en, $"room_cave_3_border.{i++}", "* (An electrical border is blocking the path.)");
	ds_map_add(global.textdata_en, $"room_cave_3_border.{i++}", "* (You feel like this is the end to some sort of \"demo\"...)");
	ds_map_add(global.textdata_en, $"room_cave_3_border.{i++}", "* (... and that a \"full game\" has been canceled,^3 too...?)");
	ds_map_add(global.textdata_en, $"room_cave_3_border.{i++}", "* (Suddenly,^3 your mouth starts moving by itself like it's trying to speak.)");
	ds_map_add(global.textdata_en, $"room_cave_3_border.{i++}", "* (You muttered...^2&\"Thanks for playing\".)");

	ds_map_add(global.textdata_en, $"unused_room_cave_3_border.{i++}", "* (Such strange feelings...)^1&* (What could they mean?)");
	ds_map_add(global.textdata_en, $"unused_room_cave_3_border.{i++}", "* (Could it be an attempt at communication from a supernatural entity...?)");
	...
	ds_map_add(global.textdata_en, "unused_battle_main_sparing_0_2", " is hypnotized.");
	ds_map_add(global.textdata_en, "battle_main_sparing_0_3", " has given up&on eating you.");
	ds_map_add(global.textdata_en, "battle_main_sparing_0_4", " is staring at the floor in silence.");
	ds_map_add(global.textdata_en, "battle_main_sparing_0_5", " is distracted.");
	...
	ds_map_add(global.textdata_en, $"battle_flee_{i++}", "* I don't think so.");
	ds_map_add(global.textdata_en, $"battle_flee_{i++}", "* Maybe later.");
	ds_map_add(global.textdata_en, $"battle_flee_{i++}", "* Apparently I'm busy.");
	...
	ds_map_add(global.textdata_en, $"battle_flee_{i++}", "* Hell no.");
	ds_map_add(global.textdata_en, $"battle_flee_{i++}", "* See ya.");
	...
	ds_map_add(global.textdata_en, $"battle_flee_{i++}", "* Can you not?");
	...
	*/
	...
	ds_map_add(global.textdata_en, "battle_act_result_dummy_1_1_0_1_0", "butterscotch pies"); // from UNDERTALE
	ds_map_add(global.textdata_en, "battle_act_result_dummy_1_1_0_1_1", "hot dogs"); // from UNDERTALE
	ds_map_add(global.textdata_en, "battle_act_result_dummy_1_1_0_1_2", "instant noodles"); // from UNDERTALE
	ds_map_add(global.textdata_en, "battle_act_result_dummy_1_1_0_1_3", "abandoned quiches"); // from UNDERTALE
	...
	// Armsguy's battle
	ds_map_add(global.textdata_en, "battle_main_armsguy", "* (Armsguy jumps in your way!)");
	...
	ds_map_add(global.textdata_en, "battle_bubble_armsguy_3", "+F1You Never Be Strong As Me.");
	ds_map_add(global.textdata_en, "battle_bubble_armsguy_4", "+F1You Should Go To Da Gym.");
	ds_map_add(global.textdata_en, "battle_bubble_armsguy_5", "+F1... What?^1&\"Leg Day\"?");
	ds_map_add(global.textdata_en, "battle_bubble_armsguy_6", "+F1Me Stronger Than You.");
	ds_map_add(global.textdata_en, "battle_bubble_armsguy_7", "+F1Want Break You Legs?");
	...
	ds_map_add(global.textdata_en, "battle_bubble_armsguy_punch_1", "+F1Mweheheh!!^1 Me Like It!");
	ds_map_add(global.textdata_en, "battle_bubble_armsguy_punch_2", "+F1Congrats,^1 Me Love It!!");
	// Trashguy's battle
	...
	ds_map_add(global.textdata_en, "battle_bubble_trashguy_7", "+F1...you're different...");
	...
	// Flitcher's battle
	ds_map_add(global.textdata_en, "battle_main_flitcher", "* (Flitcher suddenly appears&in your way.)");
	...
	ds_map_add(global.textdata_en, "battle_main_flitcher_5", "* (Flitcher doesn't think,^3 therefore it isn't.)"); // from "I think, therefore I am"
	...
	ds_map_add(global.textdata_en, "unused_battle_main_eyecrush", "* Eyecrush crawled into your way!");
	ds_map_add(global.textdata_en, "unused_battle_main_eyecrush_0", "* Eyecrush is looking at you.");
	ds_map_add(global.textdata_en, "unused_battle_main_eyecrush_1", "* Eyecrush is focused on your movements.");
	ds_map_add(global.textdata_en, "unused_battle_main_eyecrush_2", "* Eyecrush is happy he has more legs than you.");
	ds_map_add(global.textdata_en, "unused_battle_main_eyecrush_3", "* Eyecrush likes to drink eye drops for breakfast.");
	ds_map_add(global.textdata_en, "unused_battle_main_eyecrush_4", "* Eyecrush has set an unnoficial record for the longest time without blinking.");
	ds_map_add(global.textdata_en, "unused_battle_act_eyecrush_1", "Hypnotize");
	ds_map_add(global.textdata_en, "unused_battle_act_eyecrush_2", "Dance");
	ds_map_add(global.textdata_en, "unused_battle_act_result_eyecrush_0_0", "* Eyecrush - [6 ATK | 0 DEF]^1 &* This monster is a big human eye with six red legs.");
	ds_map_add(global.textdata_en, "unused_battle_act_result_eyecrush_0_1", "* Their inability to verbally communicate makes difficult&to know their interests.");
	ds_map_add(global.textdata_en, "unused_battle_act_result_eyecrush_1_0", "* (You did something mysterious and hypnotized Eyecrush.)");
	ds_map_add(global.textdata_en, "unused_battle_act_result_eyecrush_1_1", "* (This effect lasts for one turn.)");
	ds_map_add(global.textdata_en, "unused_battle_act_result_eyecrush_2_0", "* (You imitated the movements from a korean music video&you watched.)");
	ds_map_add(global.textdata_en, "unused_battle_act_result_eyecrush_2_1_0", "* (Eyecrush is very confused,^1 but liked what you did anyways.)");
	ds_map_add(global.textdata_en, "unused_battle_act_result_eyecrush_2_1_1", "* (Eyecrush couldn't understand what you did due to the hypnotization.)");
	// Broken Clock
	...
	ds_map_add(global.textdata_en, "battle_act_result_brock_1_0_0", "* (You call for help,^1 crying into the darkness...)"); // from UNDERTALE
	ds_map_add(global.textdata_en, "battle_act_result_brock_1_1_0", "* (But nobody came.)"); // from UNDERTALE
	ds_map_add(global.textdata_en, "battle_act_result_brock_2_0", "* (You tried to deal your way out,^1 but Broken Clock ignored you completely.)");
	ds_map_add(global.textdata_en, "battle_act_result_brock_3_0_0", "* (What will you say?)");
	ds_map_add(global.textdata_en, "battle_act_result_brock_3_1_0_1", "I don't wanna\nhurt you");
	ds_map_add(global.textdata_en, "battle_act_result_brock_3_1_0_2", "You're gonna\nbe okay");
	ds_map_add(global.textdata_en, "battle_act_result_brock_3_1_1_1", "I don't know\nwhere I am");
	ds_map_add(global.textdata_en, "battle_act_result_brock_3_1_1_2", "I just wanna\nhelp you");
	ds_map_add(global.textdata_en, "battle_act_result_brock_3_1_2_1", "I never did\nanything\nto you");
	ds_map_add(global.textdata_en, "battle_act_result_brock_3_1_2_2", "I just wanna\ngo home");
	ds_map_add(global.textdata_en, "battle_act_result_brock_3_1_3_1", "I didn't wanna\nbother you");
	...
	ds_map_add(global.textdata_en, "battle_bubble_brock_2_3_0", "+S2WITHOUT ANY REGRET!!!!");
	ds_map_add(global.textdata_en, "battle_bubble_brock_3_0_0", "+S2THEN,^3 THE LEADERS&OF THIS WORLD ABANDONED THIS PLACE.");
	ds_map_add(global.textdata_en, "battle_bubble_brock_3_1_0", "+S2THE CORRIDORS WERE DESTROYED AND ALMOST USELESS.");
	...
	ds_map_add(global.textdata_en, "battle_bubble_brock_4_0_0", "+S2HUMANS WILL DO THE WORST THINGS IF THEY FEEL ENTITLED ENOUGH.");
	ds_map_add(global.textdata_en, "battle_bubble_brock_4_1_0", "+S2BESIDES,^3 THOSE NEW MEMBERS HAD ABSOLUTELY NO REASON WHATSOEVER.");
	ds_map_add(global.textdata_en, "battle_bubble_brock_4_2_0", "+S2THEY DID ALL THAT JUST FOR FUN!!!!");
	ds_map_add(global.textdata_en, "battle_bubble_brock_5_0_0", "+S2YOU'RE A NEW MEMBER,^3 JUST&LIKE THEM.");
	ds_map_add(global.textdata_en, "battle_bubble_brock_5_1_0", "+S2HOW WOULD I KNOW IF YOU DIDN'T COME HERE TO KILL ME?!?");
	ds_map_add(global.textdata_en, "battle_bubble_brock_6_0_0", "+S2TO BE HONEST,^1 I DON'T WANT TO&KILL YOU.");
	ds_map_add(global.textdata_en, "battle_bubble_brock_6_1_0", "+S2BUT I ALSO DON'T WANT YOU TO TAKE AN INNOCENT LIFE.");
	ds_map_add(global.textdata_en, "battle_bubble_brock_6_2_0", "+S2WHETER IT BE MINE OR ANY OTHER MONSTER'S.");
	ds_map_add(global.textdata_en, "battle_bubble_brock_7_0_0", "+S2ALL I'M DOING&IS STOPPING A DISASTER BEFORE&IT EVEN HAPPENS.");
	ds_map_add(global.textdata_en, "battle_bubble_brock_7_1_0", "+S2I'M STOPPING MYSELF FROM REGRETTING EVER TRUSTING YOU.");
	ds_map_add(global.textdata_en, "battle_bubble_brock_8_0_0", "+S2IT'S NOT MY FAULT IF YOU'RE NOT CONVINCING ENOUGH.");
	ds_map_add(global.textdata_en, "battle_bubble_brock_8_1_0", "+S2YOU'RE NOT A BOOK.^1 I CAN'T EXACTLY \"READ\" YOU.");
	ds_map_add(global.textdata_en, "battle_bubble_brock_8_2_0", "+S2I HAVE NO OPTION BUT TO JUDGE YOU BY YOUR COVER.");
	ds_map_add(global.textdata_en, "battle_bubble_brock_9_0_0", "+S2...");
	...
	ds_map_add(global.textdata_en, "battle_bubble_brock_convince_0_1_0", "+S2YOU DON'T WANNA HURT ME?");
	ds_map_add(global.textdata_en, "battle_bubble_brock_convince_0_1_1", "+S2IF THAT'S TRUE,^3&WHY DO YOU HAVE A WEAPON WITH YOU?!?");
	ds_map_add(global.textdata_en, "battle_bubble_brock_convince_0_1_2", "+S2IS IT JUST FOR SELF-DEFENSE...?");
	...
	ds_map_add(global.textdata_en, "battle_bubble_brock_convince_1_1_1", "+S2YOU GOT HERE&BY MISTAKE?!?!");
	ds_map_add(global.textdata_en, "battle_bubble_brock_convince_1_1_2", "+S2THAT'S... ^2AWFUL.");
	ds_map_add(global.textdata_en, "battle_bubble_brock_convince_2_0_0", "+S2OH,^1 BUT YOU WILL.");
	ds_map_add(global.textdata_en, "battle_bubble_brock_convince_2_1_0", "+S2REALLY?^1&IS THAT ALL YOU WANT?");
	ds_map_add(global.textdata_en, "battle_bubble_brock_convince_2_1_1", "+S2WELL...");
	ds_map_add(global.textdata_en, "battle_bubble_brock_convince_3_0_0", "+S2TELL ME,^1 HOW COULD YOU POSSIBLY KNOW HOW I'M FEELING?!?");
	ds_map_add(global.textdata_en, "battle_bubble_brock_convince_3_0_1", "+S2IF THAT WERE TRUE,^1 YOU WOULD'VE LET ME KILL YOU ALREADY.");
	...
	ds_map_add(global.textdata_en, "battle_bubble_brock_convince_4_0_1", "+S2OH,^1 GO FUCK YOURSELF.");
	var i = 0;
	ds_map_add(global.textdata_en, $"battle_bubble_brock_convince_4_1_{i++}", "+S2DID YOU...");
	ds_map_add(global.textdata_en, $"battle_bubble_brock_convince_4_1_{i++}", "+S2DID YOU SAY&YOU'RE SORRY...?");
	ds_map_add(global.textdata_en, $"battle_bubble_brock_convince_4_1_{i++}", "+S2BUT,^2 WHY?^1 YOU...");
	...
	ds_map_add(global.textdata_en, "battle_main_armsguy_armsguy", "* (Armsguys jump in your way!)");
	ds_map_add(global.textdata_en, "battle_main_trashguy_armsguy", "* (Trashguy rolls into your way!)^3&* (Armsguy gets jealous and jumps in to save the day!)");
	ds_map_add(global.textdata_en, "battle_main_armsguy_flitcher", "* (Armsguy jumps in your way!)^3&* (Flitcher is here too,^3 somehow.)\\");
	ds_map_add(global.textdata_en, "unused_battle_main_eyecrush_armsguy", "* Eyecrush crawled into your way!^1&* Armsguy jumped in to help them!");
	ds_map_add(global.textdata_en, "unused_battle_main_eyecrush_flitcher", "* Eyecrush crawled into your way!^1&* Flitcher thinks one big eye isn't enough.");
	ds_map_add(global.textdata_en, "battle_main_armsguy_trashguy_flitcher", "* (The whole gang shows up!)");
	// Rhonhey
	...
	ds_map_add(global.textdata_en, "battle_main_rhonhey_1", "* (Rhonhey is getting closer.)");
	ds_map_add(global.textdata_en, "battle_main_rhonhey_2", "* (Rhonhey's cousin lives in a popular plumbing game about turtles.)"); // Pokey from Super Mario
	ds_map_add(global.textdata_en, "battle_main_rhonhey_3", "* (Rhonhey accidentally crushes an insect with his body.)");
	ds_map_add(global.textdata_en, "battle_main_rhonhey_4", "* (You feel the worst smell imaginable coming from Rhonhey's mouth.)");
	...
	ds_map_add(global.textdata_en, "battle_act_result_rhonhey_0", "* Rhonhey - [?? ATK | ?? DEF]^1 &* [No data available.]"); // from UNDERTALE
	...
	ds_map_add(global.textdata_en, "battle_act_result_rhonhey_2_1", "* (Rhonhey didn't understand&what you said.)^1&* (Nothing happened.)"); // from UNDERTALE
	...
	var i = 0;
	ds_map_add(global.textdata_en, $"battle_main_troll_{i++}", "* (TROLLFACE is laughing at his own jokes.)");
	ds_map_add(global.textdata_en, $"battle_main_troll_{i++}", "* (TROLLFACE is laughing uncomfortably loud.)");
	ds_map_add(global.textdata_en, $"battle_main_troll_{i++}", "* (TROLLFACE is whispering inappropriate compliments.)");
	ds_map_add(global.textdata_en, $"battle_main_troll_{i++}", "* (TROLLFACE is sharing overly intimate secrets.)");
